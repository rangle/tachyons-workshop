...
More Customizable Alternative<br/>
...
<iframe
  ...
  scrolling='no'
  title='KxPVjm'
  src='//codepen.io/winkerVSbecks/embed/KxPVjm/?height=500&theme-id=light&default-tab=js,result&embed-version=2&editable=true'
  frameBorder='no'

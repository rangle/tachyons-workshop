...
<Flex alignItems="center">
  <BrowserChrome>
    <img src="img/tachyons-design-system.gif" style={{width: 500, display: 'block'}} />
  </BrowserChrome>
  <Box ml={5}>
    <h1 style={{lineHeight: 1.25}}>Tachyons<br/>Design System</h1>
  </Box>
</Flex>
...
**[Theming](http://tachyons.io/docs/themes/skins/)**<br/>
...
# [tachyons-tldr.now.sh](https://tachyons-tldr.now.sh/#/scales)
...
<img
  ...
  style={{width: 256, marginTop: '2em', marginLeft: 'auto', marginRight: '2em', display: 'block'}}
/>
